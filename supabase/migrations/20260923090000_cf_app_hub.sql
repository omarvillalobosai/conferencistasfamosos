...
-- 7. Endurecimiento (según el linter de seguridad de Supabase, 2026-09-22) ----------------------
REVOKE EXECUTE ON FUNCTION public.cf_sync_contact_from_quote() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.cf_contact_events_after_insert() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.cf_contacts_touch() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.cf_is_app_user() FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.cf_is_app_user() TO authenticated;
ALTER FUNCTION public.cf_contacts_touch() SET search_path = public;
