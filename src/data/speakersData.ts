...
export const speakers: Speaker[] = [
  {
    ...
    image: '/img/speakers/omar-villalobos.webp',
    specialty: 'Alto Impacto y Transformación Personal',
    shortBio: 'Top 3 speakers de Latinoamérica, más de 3,500 conferencias en 30+ países, Récord Guinness y tres doctorados honoris causa',
    fullBio: `Omar Villalobos es un conferencista internacional, autor y capacitador mexicano, reconocido entre los tres speakers más influyentes de Latinoamérica, con más de 30 años de trayectoria en desarrollo humano, liderazgo y ventas. Estudió Business Psychology en la Universidad de Texas en El Paso (UTEP) y cursó una maestría en Terapia Gestalt en Guadalajara, México.\n\nHa impartido más de 3,500 conferencias en más de 30 países y más de 150 ciudades con eventos en vivo, acumulando más de tres millones de millas en avión. Sus conferencias abordan liderazgo, ventas, autoestima, mentalidad de alto rendimiento y transformación personal, combinando psicología aplicada con estrategias de negocio.\n\nEs autor del bestseller Ser Chingón Sin Ir a Harvard y de más de 40 audiolibros de desarrollo humano, y es el autor latino con más participaciones en el movimiento TEDx, con cuatro charlas. Pionero de YouTube desde 2007, suma más de 1,500 videos publicados, más de 350,000 seguidores y más de 50 millones de vistas en redes.\n\nEntre sus reconocimientos destacan el Récord Guinness por la mayor cantidad de personas abrazadas simultáneamente durante un minuto (Arena México, 2010), superado por él mismo en Ayacucho, Perú, en 2012 con más de 10,000 personas, y tres doctorados honoris causa.\n\nOmar Villalobos ofrece conferencias corporativas, seminarios, programas de coaching y contenido a través de su academia digital, personalizando cada conferencia según los retos específicos de la organización o audiencia que lo contrata.`,
  ...
  },
  {
    id: 2,
    name: 'Yordi Rosado',
    image: '/img/speakers/yordi-rosado.webp',
  ...
  },
  {
    id: 3,
    name: 'Daniel Habif',
    image: '/img/speakers/daniel-habif.webp',
  ...
  },
  {
    id: 4,
    name: 'Odin Dupeyron',
    image: '/img/speakers/odin-dupeyron.webp',
  ...
  },
  {
    id: 5,
    name: 'César Lozano',
    image: '/img/speakers/cesar-lozano.webp',
  ...
  },
  {
    id: 6,
    name: 'Ismael Cala',
    image: '/img/speakers/ismael-cala.webp',
  ...
  },
  {
    id: 7,
    name: 'Carlos Páez',
    image: '/img/speakers/carlos-paez.webp',
  ...
  },
  {
    id: 8,
    name: 'Victor Kuppers',
    image: '/img/speakers/victor-kuppers.webp',
  ...
  },
  {
    id: 9,
    name: 'Adriana Macías',
    image: '/img/speakers/adriana-macias.webp',
  ...
  },
  {
    id: 10,
    name: 'Gaby Vargas',
    image: '/img/speakers/gaby-vargas.webp',
  ...
  },
  {
    id: 11,
    name: 'Elsa Punset',
    image: '/img/speakers/elsa-punset.webp',
  ...
  },
  {
    id: 12,
    name: 'Marisa Lazo',
    image: '/img/speakers/marisa-lazo.webp',
  ...
  },
  {
    id: 13,
    name: 'Vilma Núñez',
    image: '/img/speakers/vilma-nunez.webp',
  ...
  },
  {
    ...
    image: '/img/speakers/claudia-lizaldi.webp',
