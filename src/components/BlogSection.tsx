...
const blogPosts = [
  {
    ...
    date: '12 Enero, 2025',
    readTime: '5 min',
    slug: 'que-hace-grande-a-un-conferencista'
  },
  {
    id: 2,
    ...
    date: '5 Febrero, 2025',
    readTime: '7 min',
    slug: '5-claves-para-elegir-speaker-ideal'
  },
  {
    id: 3,
    ...
    date: '20 Marzo, 2025',
    readTime: '6 min',
    slug: 'conferencistas-mas-influyentes-2025'
  }
];
          ...
          {`
            {
              ...
              "@type": "Blog",
              "name": "Blog de ConferencistasFamosos.com",
              "description": "Artículos sobre conferenciantes, eventos y motivación",
              "url": "https://conferencistasfamosos.com/blog",
              "blogPost": [
                ${blogPosts.map(post => `
                {
                  "@type": "BlogPosting",
              ...
              <Card key={post.id} className="overflow-hidden h-full flex flex-col">
                ...
                <CardContent className="pt-6 flex-grow">
                  ...
                  <h3 className="text-xl font-bold mb-3">
                    <Link to={`/blog/${post.slug}`} className="hover:text-orange-500 transition-colors">
                      {post.title}
                    </Link>
                  </h3>
