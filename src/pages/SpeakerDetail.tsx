...
import { Youtube, BookOpen, Award, Calendar, Star } from 'lucide-react';
    ...
    <>
      ...
      <main>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold mb-12 text-center flex items-center justify-center">
              <Calendar className="text-green-600 mr-3" size={32} />
              Próximos Eventos
            </h2>
            <div className="max-w-4xl mx-auto text-center">
              <p className="text-lg text-gray-600">
                Actualmente no hay eventos públicos programados con {speaker.name}.
              </p>
              <p className="text-lg mt-4">
                ¿Quieres ser el primero en enterarte de nuevos eventos?
              </p>
              <div className="mt-8">
